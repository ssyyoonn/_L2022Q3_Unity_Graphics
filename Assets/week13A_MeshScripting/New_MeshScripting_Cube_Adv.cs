...
public class New_MeshScripting_Cube_Adv : MonoBehaviour
{
    Vector3 V0, V1, V2, V3, V4, V5, V6, V7;
    Vector3[] newVertices;
    int[] newTriangles;
    Vector3[] newNormals;   // Normal 추가
    void Start()
    {
        ...
        newVertices = new Vector3[] // 각 면에 대해, 면을 이루는 꼭짓점 4개의 Vertex 값으로 표현
        {                           // 4개의 꼭짓점으로 이루어진 6개의 면 => 24개
            // Front
            V0, V4, V7, V3, //0, 1, 2, 3 (인덱스 값)
            // Right 
            V3, V7, V6, V2, //4, 5, 6, 7 
            // Back
